-- ===============================================
-- إضافة الحسابات الجديدة فقط (بدون حذف البيانات الموجودة)
...
BEGIN
    RAISE NOTICE '===============================================';
    RAISE NOTICE '🚀 بدء إضافة الحسابات الجديدة (نسخة آمنة)';
    ...
    -- إضافة المدير المخفي (إذا لم يكن موجود)
    INSERT INTO users (
    ...
    RAISE NOTICE '✅ تم إضافة المدير المخفي: ameer / ameer_7elwas';
    
    -- إضافة 10 مستخدمين عاديين
    INSERT INTO users (
        username, password_hash, full_name, email, phone, role,
        can_delete_centers, can_delete_employees, 
        can_view_all_centers, can_view_all_employees,
    ...
    RAISE NOTICE '✅ تم إضافة 10 مستخدمين عاديين';
    
    -- إضافة مديرين عاديين بكامل الصلاحيات (بدون النسخ الاحتياطي)
    INSERT INTO users (
        username, password_hash, full_name, email, phone, role,
        can_delete_centers, can_delete_employees, 
        can_view_all_centers, can_view_all_employees,
    ...
    ('admin1', crypt('Admin@Full2024!Manager1', gen_salt('bf', 12)), 'مدير 1', 'admin1@company.com', '07721234567', 'admin', true, true, true, true, true, false, setup_time, setup_time, setup_time),
    ('admin2', crypt('Admin@Full2024!Manager2', gen_salt('bf', 12)), 'مدير 2', 'admin2@company.com', '07821234567', 'admin', true, true, true, true, true, false, setup_time, setup_time, setup_time)
    ON CONFLICT (username) DO NOTHING;
    
    RAISE NOTICE '✅ تم إضافة 2 مديرين عاديين';
    ...
    RAISE NOTICE '';
    RAISE NOTICE '===============================================';
    RAISE NOTICE '✅ تمت إضافة الحسابات الجديدة بنجاح!';
    ...
    RAISE NOTICE '';
    RAISE NOTICE '👨‍💼 المديرين العاديين (2 حسابات - كامل الصلاحيات بدون النسخ الاحتياطي):';
    ...
    RAISE NOTICE '';
    RAISE NOTICE '🔐 معلومات المدير المخفي:';
    RAISE NOTICE '   اسم المستخدم: ameer';
    RAISE NOTICE '   كلمة المرور: ameer_7elwas';
    RAISE NOTICE '   الاسم الكامل: أمير';
    RAISE NOTICE '   البريد الإلكتروني: ameer@system.local';
    RAISE NOTICE '   الصلاحيات: جميع الصلاحيات + النسخ الاحتياطي';
    RAISE NOTICE '';
    RAISE NOTICE '🔐 معلومات المديرين العاديين:';
    RAISE NOTICE '   admin1: Admin@Full2024!Manager1 - مدير 1';
    RAISE NOTICE '   admin2: Admin@Full2024!Manager2 - مدير 2';
    RAISE NOTICE '   الصلاحيات: كامل الصلاحيات (حذف وتعديل) بدون النسخ الاحتياطي';
    RAISE NOTICE '';
    RAISE NOTICE '🔐 كلمات مرور المستخدمين العاديين (جميعها قوية ومعقدة):';
    RAISE NOTICE '   مستخدم 1: Secure@Pass2024!User1';
    RAISE NOTICE '   مستخدم 2: Strong#Password2024$User2';
    RAISE NOTICE '   مستخدم 3: Complex!Pass2024%%User3';
    RAISE NOTICE '   مستخدم 4: Advanced@Pass2024^User4';
    RAISE NOTICE '   مستخدم 5: Robust#Pass2024&User5';
    RAISE NOTICE '   مستخدم 6: Powerful!Pass2024*User6';
    RAISE NOTICE '   مستخدم 7: Enhanced@Pass2024+User7';
    RAISE NOTICE '   مستخدم 8: Protected#Pass2024=User8';
    RAISE NOTICE '   مستخدم 9: Fortified!Pass2024-User9';
    RAISE NOTICE '   مستخدم 10: Defended@Pass2024_User10';
    RAISE NOTICE '';
    RAISE NOTICE '✅ النظام جاهز الآن مع حساب مدير مخفي آمن و 10 مستخدمين عاديين + 2 مديرين عاديين!';
    RAISE NOTICE '✅ جميع البيانات الموجودة محفوظة بالكامل';
    RAISE NOTICE '✅ يمكنك إضافة المستخدمين من خلال الصفحة';
    RAISE NOTICE '✅ المدير المخفي لا يظهر في قائمة المستخدمين';
    RAISE NOTICE '✅ المستخدمين العاديين لا يشاهدون النسخ الاحتياطي';
    RAISE NOTICE '✅ المديرين العاديين لا يشاهدون النسخ الاحتياطي';
    RAISE NOTICE '✅ جميع كلمات المرور آمنة ومشفرة وقوية';
    RAISE NOTICE '✅ النظام يدعم التوقيت العراقي';
    RAISE NOTICE '✅ جميع الميزات المتقدمة مُفعّلة';
    RAISE NOTICE '✅ المدير المخفي له كلمة مرور بسيطة وآمنة';
    RAISE NOTICE '✅ جميع المستخدمين العاديين لديهم كلمات مرور قوية ومعقدة';
    RAISE NOTICE '✅ المديرين العاديين لديهم كلمات مرور قوية ومعقدة';
    RAISE NOTICE '===============================================';

EXCEPTION
    WHEN OTHERS THEN
        RAISE NOTICE '❌ خطأ في إضافة الحسابات: %', SQLERRM;
        RAISE;
END $$;
